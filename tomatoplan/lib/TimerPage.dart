...
class Dependencies {
  ...
  final TextStyle textStyle = const TextStyle(fontSize: 40.0, fontFamily: "Bebas Neue",fontWeight: FontWeight.w400);
...
//          flex: 0,
          child: new Padding(
            ...
            child: new Row(
              ...
              children: <Widget>[
                buildFloatingButton(dependencies.stopwatch.isRunning ? "重置" : "重置", leftButtonPressed),
                buildFloatingButton(dependencies.stopwatch.isRunning ? "暂停" : "开始", rightButtonPressed),
              ],
            ),
          ),
        ),
